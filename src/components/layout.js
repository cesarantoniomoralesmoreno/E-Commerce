  ...
  return (
    ...
    <section>
      <nav>
        ...
        <ul>
        {
        categories.data && renderCategories()  //Para proteger esto de que en algun momento no este definida la matriz que estamos pasando al useState colocamos esto && lo otro
        }
        </ul>
